...
-(NSString *)uuidForDevice
{
    ...
    NSMutableString *device = [[NSMutableString alloc]initWithString:_uuidForDevice];
    [device insertString:@"-" atIndex:8];
    [device insertString:@"-" atIndex:13];
    [device insertString:@"-" atIndex:18];
    [device insertString:@"-" atIndex:23];
    return device;
}
